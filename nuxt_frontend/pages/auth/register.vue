      ...
      <div class="w-full max-w-md space-y-8">
        <div class="flex flex-col items-center text-center">
          ...
          <p class="text-muted-foreground">
            Join the Hydraulic Diagnostic Platform
          </p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6 animate-slide-up">
          ...
          <div class="flex items-center space-x-2">
            <UiCheckbox id="terms" v-model="acceptTerms" />
            <UiLabel for="terms" class="text-sm">
          ...
          <UiButton type="submit" class="w-full" size="lg" :disabled="isLoading || !acceptTerms">
      ...
      <div class="relative z-10 flex flex-col justify-center space-y-6 text-white">
        <div class="space-y-6 animate-slide-up">
          ...
          <p class="text-lg text-white/90 max-w-md">
            Join thousands of engineers who trust our platform for predictive maintenance
            and real-time hydraulic system monitoring.
          </p>
          <div class="space-y-4 pt-4">
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="font-medium">Team Collaboration</p>
                <p class="text-sm text-white/70">
            ...
            <div class="flex items-center gap-3">
              <div class="h-12 w-12 rounded-lg bg-white/20 backdrop-blur flex items-center justify-center">
                <Icon name="lucide:trending-up" class="h-6 w-6" />
              </div>
              <div>
                <p class="font-medium">Predictive Analytics</p>
                <p class="text-sm text-white/70">
                  Reduce downtime with AI-powered predictions
                </p>
              </div>
            </div>
          </div>
