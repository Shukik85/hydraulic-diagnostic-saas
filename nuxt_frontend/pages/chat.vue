...
const chatSessions = ref<ChatSession[]>([
  {
    ...
    messages: [
      ...
      },
      {
        id: 2,
        role: 'assistant',
        content: 'Система HYD-001 работает стабильно. Температура: 45.2°C, давление: 150.8 бар. Рекомендую проверить фильтры в течение 2 недель.',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 2,
        role: 'assistant',
        content: 'Рекомендую установить частотные преобразователи с регулируемой скоростью и систему рекуперации энергии.',
...
const sendMessage = async (): Promise<void> => {
  ...
  try {
    ...
    const assistantMessage: ChatMessage = {
      ...
      timestamp: new Date().toISOString(),
      sources: [
        { title: 'Техническая документация', url: '/docs/hydraulic-systems.pdf' }
      ]
    }
...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div v-if="activeSession" class="max-w-4xl mx-auto">
            ...
            >
              ...
              <div :class="[
                ...
                <p class="text-sm leading-relaxed whitespace-pre-wrap" :class="message.role === 'user' ? 'text-white' : 'text-gray-900 dark:text-white'">
                  {{ message.content }}
                </p>
    ...
    <!-- New Session Modal -->
    <div v-if="showNewSessionModal" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center" @click="showNewSessionModal = false">
