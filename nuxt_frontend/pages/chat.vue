<template>
  <div class="flex h-[calc(100vh-8rem)] bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden">
    ...
    <div class="hidden lg:flex w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex-col">
      <!-- Sidebar Header -->
    ...
    <div 
      class="lg:hidden fixed inset-y-0 left-0 z-40 w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transform transition-transform duration-300 ease-in-out"
    ...
    <!-- Chat Area -->
    <div class="flex-1 lg:flex-none lg:flex-grow flex flex-col bg-white dark:bg-gray-800 min-h-0">
      ...
      <!-- Message Input -->
      <div v-if="activeSession" class="border-t border-gray-200 dark:border-gray-700 p-6 bg-white dark:bg-gray-800">
