...
module.exports = {
  ...
  theme: {
    extend: {
      // Premium color palette with better contrast and accessibility
      colors: {
      ...
      boxShadow: {
        ...
        'elevation-4': '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -1px rgb(0 0 0 / 0.06)',
        'elevation-8': '0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -2px rgb(0 0 0 / 0.05)',
