        ...
        <div class="flex items-center justify-between h-16">
          ...
          <NuxtLink to="/" class="flex items-center space-x-3 mr-8">
            ...
            <div>
              ...
              <span class="block text-xs text-gray-600 dark:text-gray-400 leading-tight">Диагностическая платформа</span>
            </div>
          </NuxtLink>

          <!-- Публичные ссылки с единым стилем -->
          <div class="hidden md:flex items-center space-x-8">
            <a href="#features" class="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">Возможности</a>
            <a href="#benefits" class="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">Преимущества</a>
            <NuxtLink to="/investors" class="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">Для инвесторов</NuxtLink>
          </div>

          <!-- Действия -->
          <div class="flex items-center space-x-3">
            <button @click="toggleTheme" :disabled="!isHydrated" class="p-2 rounded-lg text-gray-600 hover:text-blue-600 transition-colors disabled:opacity-50" title="Переключить тему">
              <ClientOnly>
            ...
            <NuxtLink to="/auth/login" class="px-4 py-2 text-sm font-medium rounded-lg text-gray-600 hover:text-blue-600 transition-colors">Войти</NuxtLink>
            <NuxtLink to="/dashboard" class="px-6 py-2.5 text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors">Открыть дашборд</NuxtLink>
          </div>
      ...
      <div class="container mx-auto px-4 py-12">
        <div class="grid md:grid-cols-4 gap-8">
          <div class="md:col-span-2">
            ...
            <p class="text-gray-300 mb-6 leading-relaxed">Передовая платформа диагностики и мониторинга промышленных гидравлических систем с использованием искусственного интеллекта.</p>
          </div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 text-center">
          <p class="text-gray-400 text-sm">© {{ new Date().getFullYear() }} Гидравлика ИИ. Все права защищены.</p>
        </div>
      </div>
    </footer>
  </div>
