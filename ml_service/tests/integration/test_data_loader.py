...
def main():
    ...
    try:
        ...
        data = load_uci_hydraulic_data(filename=small_file, window_minutes=5)
        ...
        if (data_path / large_file).exists():
            ...
            try:
                large_data = load_uci_hydraulic_data(filename=large_file, window_minutes=5)
        ...
        print("💪 Ready to train models on REAL data!")
        ...
        test_report = {
            ...
            "data_quality": {
                ...
                "feature_ranges": {"min": float(feature_mins.min()), "max": float(feature_maxs.max())},
