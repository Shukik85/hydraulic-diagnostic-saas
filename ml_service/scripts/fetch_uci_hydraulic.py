...
SENSOR_MAP = {
    ...
    "VS1": ("vibration", 1),"EPS1": ("pressure", 1),
}
...
def wide_row_to_long(row: pd.Series, sensor_name: str, sensor_type: str, hz: int, cycle: int, system_id: str) -> pd.DataFrame:
