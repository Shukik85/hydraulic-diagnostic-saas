...
import uuid
from apps.core.enums import ErrorSeverity, SupportTicketStatus, SupportPriority, DataExportStatus, SupportActionType
...
class SupportTicket(models.Model):
    ...
    message = models.TextField()
    priority = models.CharField(max_length=20, choices=PRIORITY_CHOICES, default=SupportPriority.MEDIUM.value)
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default=SupportTicketStatus.OPEN.value)
...
class DataExportRequest(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user_id = models.UUIDField(db_index=True)
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default=DataExportStatus.PENDING.value)
