...
class APILogAdmin(admin.ModelAdmin):
    list_display = ['method', 'path_short', 'status_code_colored', 'response_time_ms', 'user_id', 'created_at']
    list_filter = ['method', 'status_code', 'created_at']
    search_fields = ['path', 'user_id']
    readonly_fields = ['id', 'user_id', 'method', 'path', 'status_code', 
...
class ErrorLogAdmin(admin.ModelAdmin):
    list_display = ['severity_badge', 'error_type', 'message_short', 'user_id', 'created_at']
    list_filter = ['severity', 'error_type', 'created_at']
    search_fields = ['error_type', 'message']
    readonly_fields = ['id', 'user_id', 'severity', 'error_type', 'message', 
