...
class EmailCampaignAdmin(admin.ModelAdmin):
    list_display = ['name', 'subject', 'status_badge', 'recipients_count', 'opened_count', 'scheduled_for', 'sent_at']
    list_filter = ['status', 'target_tier']
    search_fields = ['name', 'subject']
    readonly_fields = ['recipients_count', 'opened_count', 'clicked_count', 'sent_at', 'created_at']

    def status_badge(self, obj):
        colors = {'draft': 'gray', 'scheduled': 'orange', 'sending': 'blue', 'sent': 'green', 'failed': 'red'}
