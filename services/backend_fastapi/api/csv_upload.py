...
from schemas.csv_upload import (
...
async def validate_csv(
    ...
    # Missing sensors
    missing_sensors = valid_sensor_ids - csv_columns
    if missing_sensors:
        warnings.append({
            'field': 'sensors',
    ...
    # Unknown sensors
    unknown_sensors = csv_columns - valid_sensor_ids
    if unknown_sensors:
        errors.append({
            'field': 'sensors',
    ...
    # 4. Check value ranges (warnings only)
