<template>
  <nav
    class="sticky top-0 z-50 bg-metal-dark border-b border-steel-light/20 backdrop-blur-sm"
    role="navigation"
  ...
  >
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center gap-2">
          <!-- Language Switcher -->
          <button
            class="p-2 rounded-lg text-gray-300 hover:text-white hover:bg-gray-600/10 transition-all"
          ...
          <div class="hidden md:block relative">
            <button
              class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-600/10 transition-all"
          ...
          <!-- Mobile Menu Toggle -->
          <button
            class="md:hidden p-2 rounded-lg text-gray-300 hover:text-white hover:bg-gray-600/10 transition-all"
    ...
    <Transition name="mobile-menu">
      <div
        ...
        class="md:hidden border-t border-steel-light/20 bg-metal-medium"
      >
