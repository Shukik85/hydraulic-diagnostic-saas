      ...
      <form @submit.prevent="handleRegister" class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input id="lastName" v-model="form.lastName" type="text"
              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
              placeholder="Петров" :disabled="isLoading" />
          </div>
        </div>
        ...
        <div>
          ...
          <input id="email" v-model="form.email" type="email" required
            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            placeholder="ivan.petrov@company.com" :disabled="isLoading" />
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" required
              ...
              placeholder="Создайте надёжный пароль" :disabled="isLoading" />
        ...
        <div>
          ...
          <input id="confirmPassword" v-model="form.confirmPassword" :type="showConfirmPassword ? 'text' : 'password'"
            required
            class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            :class="{ 'border-red-300': passwordMismatch && form.confirmPassword }" placeholder="Повторите пароль"
            :disabled="isLoading" />
        ...
        <div class="flex items-start gap-3">
          <input id="agreeTerms" v-model="form.agreeTerms" type="checkbox" required
            class="mt-1 w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" :disabled="isLoading" />
