...
class RagSystemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RagSystem
        fields = ['id', 'name', 'description', 'model_name', 'index_type', 'index_config', 'created_at', 'updated_at', 'document_count', 'query_count']
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class RagQueryLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RagQueryLog
        fields = ['id', 'system', 'system_name', 'document', 'document_title', 'query_text', 'response_text', 'timestamp', 'metadata']
